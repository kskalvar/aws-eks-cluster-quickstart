...
QuickStart will build on CloudFomration scripts AWS has already provided and fully automate the creation of the  
EKS Cluster.  Will also use a cloud-init and shell scripts to configure an EC2 instance with kubectl installed  
and configured to talk to the cluster.  
